...
const Ms = ({ icon, size = 20, fill = 1, color = 'currentColor', style = {} }) => (
  <span style={{
  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-menu">
        ...
        {!isInstalled && (installPrompt || isIOS) && (
          <MenuItem icon="download" title="Ilovani o'rnatish" sub="Telefon ekraniga qo'shish" action={handleInstall}
